...
export function SearchScreen({ texts, index, browse }: SearchScreenProps) {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-background">
      ...
      <div className="flex shrink-0 items-center gap-2 bg-[hsl(var(--brand-primary))] px-3 pb-1.5 pt-11">
        <button
          type="button"
          aria-label="Back"
          onClick={() => router.back()}
        ...
        <div className="flex h-10 flex-1 items-center gap-2 rounded-full bg-white px-4 text-foreground/50">
          <Glass />
          <input
            ref={inputRef}
            value={query}
