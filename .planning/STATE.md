...
**Fase activa:** Fase 0 — Bootstrap del repo.

**Siguiente acción concreta:** inicializar git y hacer el primer commit; luego arrancar Fase 1 (scaffolding de Next.js).
...
_(sin entradas todavía — el bootstrap aún no está commiteado)_
