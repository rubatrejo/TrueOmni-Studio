...
- *(Pendiente de definir al recibir los SVGs. A completar en fase 1.)*
...
Cada fase del `ROADMAP.md` debe referenciar qué requerimientos cubre (ej. *"Fase 2: cubre R1, R3, R4"*).
