 ...
 *
 * Nota: `branding.idleBackground` NO sobreescribe el background del Billboard.
 * El idle muestra siempre su imagen (configurada o default); para poner un
 * video/YouTube en el idle el operador usa el botón "Use brand video" del
 * Billboard editor (que escribe `override.background` explícitamente).
 */
